...
import com.flort.evlilik.modules.main.components.LikesGridItemView
import com.flort.evlilik.modules.main.profile.ProfileActivity
import com.flort.evlilik.components.LikesGridSkeletonList
import com.flort.evlilik.network.ApiClient
import com.flort.evlilik.models.profile.like.LikedUser
        ...
        if (!isVisible.value || !isPremium.value) {
            ...
            androidx.compose.material3.Card(
                ...
                Column(
                    ...
                    Button(
                        onClick = {
                            val intent = android.content.Intent(context, com.flort.evlilik.modules.wallet.VipActivity::class.java)
