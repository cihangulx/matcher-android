...
import com.flort.evlilik.modules.auth.components.StepView
import com.flort.evlilik.modules.auth.components.BottomActions
            ...
            coroutineScope.launch {
                ...
                try {
                    ...
                    val gallery = uploadedUrls.mapIndexedNotNull { index, url ->
                        if (url != null) {
                            com.flort.evlilik.models.auth.GalleryItem(
                                index = index,
                                url = url,
                                isMain = index == 0
                            )
