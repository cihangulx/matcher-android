...
import com.matcher.matcher.utils.events.ProfileEvent
import com.matcher.matcher.utils.events.ProfileEventManager
...
import com.matcher.matcher.models.user.copy
import com.matcher.matcher.modules.main.components.HomeProfileItemView
import com.matcher.matcher.modules.main.profile.ProfileActivity
import com.matcher.matcher.modules.main.message.NewMessageActivity
import com.matcher.matcher.components.ProfileSkeletonView
    ...
    /*val sampleProfiles = remember {
        listOf(
            ...
            Profile().apply {
                ...
                gallery = arrayListOf(
                    GalleryImage().apply { localImage = com.matcher.matcher.R.mipmap.temp_profile_3 },
                    GalleryImage().apply { localImage = com.matcher.matcher.R.mipmap.temp_profile_5 }
                )
            },
            Profile().apply {
                name = "Canan"
